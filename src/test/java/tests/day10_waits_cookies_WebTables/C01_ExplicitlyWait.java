...
public class C01_ExplicitlyWait {
    ...
    public void explicitlyWaitTest(){
        ...
        /*
        visibilityof methodu bize iki secenek sunuyor
        eger webelementi locate edebiliyorsak once locate edip sonra o elementi istenen condition icin
        beklemesini isteyebiliriz
        eger locate edemiyorsak o zaman  locate islemi ile bekleme islemini birlikte yapabiliriz
         */
